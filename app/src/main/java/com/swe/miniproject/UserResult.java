...
public class UserResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBackToMain.setOnClickListener(v -> {
            ...
            Intent intent;
            if ("STPM".equals(sourceActivity)) {
                intent = new Intent(UserResult.this, StpmEligibilityActivity.class);
            } else {
                intent = new Intent(UserResult.this, MainActivity.class);
            }
        ...
        lvUserEligibleCourses.setOnItemClickListener((parent, view, position, id) -> {
            String selectedCourse = (String) parent.getItemAtPosition(position);
            // Remove the programme type in brackets
            String courseName = selectedCourse.replaceAll("\\s*\\(.*\\)", "");
            Intent intent = new Intent(UserResult.this, ProgrammeListActivity.class);
            intent.putExtra("programmeTitle", courseName);
            intent.putExtra("programmeList", getDiplomaCourseDetails(courseName));
            startActivity(intent);
        });
    }
